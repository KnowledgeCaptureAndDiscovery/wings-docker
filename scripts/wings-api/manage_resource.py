...
parser.add_argument("-p", "--password", help="Portal password", default="4dm1n!23")
parser.add_argument("-m", "--machine", help="Machine id", default=localhost)
parser.add_argument("-gm", "--get_machine", help="Get Machine details", action="store_true")
parser.add_argument("-sm", "--save_machine", help="Save Machine details", action="store_true")
parser.add_argument("-f", "--machine_file", help="File to get Machine details from")
