...
with open(sys.argv[1], 'rb') as csvfile:
    ...
    for row in fdata:
        ...
        sampleid = row[2]
        patientid = row[3]
        data.save_metadata(rnafile, {'hasSpeciesName': 'HS', 'hasParticipantID': patientid,
                                     'hasSampleID': sampleid, 'hasDatasetID': 'COADREAD'})
        data.save_metadata(msfile, {'hasSpeciesName': 'HS', 'hasParticipantID': patientid,
                                    'hasSampleID': sampleid, 'hasDatasetID': 'COADREAD'})
